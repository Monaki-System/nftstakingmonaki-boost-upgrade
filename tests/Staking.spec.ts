...
describe('Staking', () => {
    ...
    it('should stake items', async () => {
        {
            ...
            expect(helperData.staker).toEqualAddress(users[0].address);
            expect(helperData.stakedAt).toEqual(1600000000);
            expect(helperData.option).toEqual(7);
            expect(
                (
...

        {
            ...
            let helperData = await helper.getContractData();
            expect(helperData.staker).toEqualAddress(users[1].address);
            expect(helperData.stakedAt).toEqual(1600000000);
            expect(helperData.option).toEqual(30);
            expect(
                (
                    await stakingMaster.getItemsStakedByUser(
                        users[1].address,
    ...
    it('should claim rewards', async () => {
...

        {
            ...
            const helper = blockchain.openContract(await stakingMaster.getHelper(item.address));
            let helperData = await helper.getContractData();
            expect(helperData.stakedAt).toEqual(1600000000 + 86400 * 7);
            expect(helperData.option).toEqual(14);
            expect(
                (
                    await stakingMaster.getItemsStakedByUser(
                        users[0].address,
            ...
            expect(helperData.stakedAt).toEqual(0);
            expect((await stakingMaster.getContractData()).stakedItems.keys()).toHaveLength(0);
        }

        {
            ...
            const helper = blockchain.openContract(await stakingMaster.getHelper(item.address));
            let helperData = await helper.getContractData();
            expect(helperData.stakedAt).toEqual(1600000000 + 86400 * (7 + 14));
            expect(helperData.option).toEqual(7);
            expect(
                (
                    await stakingMaster.getItemsStakedByUser(
